...
const getInvoice = async () => {
  let response = await axios.get(`/api/invoice_edit/${props.id}`);
      ...
      <div class="card__content">
        <div class="card__content--header">
          ...
          <div>
            ...
            <input type="text" v-model="form.number" class="input" />
            <p class="my-1">Reference(Optional)</p>
            <input type="text" v-model="form.reference" class="input" />
          </div>
        </div>
        <br /><br />
        <div class="table">
          ...
          >
            ...
            <p>
              <input type="text" v-model="itemcart.unit_price" class="input" />
            </p>
            <p>
              <input type="text" v-model="itemcart.quantity" class="input" />
            </p>
